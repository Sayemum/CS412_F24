#    name: cs412_reading_input.py
# purpose: Showcase how to read in lines of integers and cast them
...
def main():
    # This does not work since it reads in all
    # the input as strings

    #in_list = input().split()

    # This takes each element in the list
    # and casts it as an int
    # 8 10 1 3 6 7
    # 6
